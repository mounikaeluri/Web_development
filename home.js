...
$(document).ready(function () {
   ...
   // checkLoginStatus();
    ...
    $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/fetch_vendor.cgi', handleVendor);
    $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/fetch_category.cgi', handleCategory);
...
function searchSKU() {
    ...
    if (keyword.length > 0) {
        $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/search_sku.cgi?search=' + keyword, handleSearch);
    }
}
...
function deleteSearchSKU() {
   ...
   checkLoginStatus();
    ...
    if (keyword.length > 0) {
        $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/search_sku.cgi?search=' + keyword, handleDeleteSearch);
    }
...
function editRecord() {
    ...
    $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/fetch_row_sku.cgi?sku=' + sku, populateEditForm);
}
...
function deleteRecord() {
    ...
    if (confirm("Are you sure you want to delete the record?") == true) {
        ...
        var sku = row.cells[1].innerHTML;
        //console.log(rownumber +":"+ sku);
        $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/deleteproduct.cgi?sku=' + sku, handleDeleteSKU);
    }
...
function populateEditForm(response) {
    ...
    $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/fetch_vendor.cgi', handleEditVendor);
    $.get('http://jadran.sdsu.edu/perl/jadrn034/proj1/fetch_category.cgi', handleEditCategory);
    ...
    document.getElementById("editImage").setAttribute("src", "/~jadrn034/proj1/file_upload/_tk_images/" + columns[0].toLowerCase() + ".jpg");
...
function checkForDuplicateSKU() {
    ...
    if (validateSKU()) {
        ...
        $.ajax({
            url: "/perl/jadrn034/proj1/check_dup_sku.cgi?sku=" + skuvalue,
            dataType: "html",
...
function checkLoginStatus() {
    ...
    var re = new RegExp("jadrn034_SID" + "=([^;]+)");                  // Code to retrieve cookie adapted from http://www.the-art-of-web.com/javascript/getcookie/
    var mycookie = re.exec(document.cookie);

    if (mycookie == null || mycookie == "") {

        window.location = "http://jadran.sdsu.edu/~jadrn034/proj1/";
    }

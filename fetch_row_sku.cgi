...
my $query = "select sku, vendor.name as vendor, category.name as category , mfdid, description, features, cost, retail from products,vendor, category  where sku='$keyword' and vendor.id=products.vendorid and category.id=products.catid";
